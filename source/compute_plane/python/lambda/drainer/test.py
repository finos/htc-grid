...
def _lambda_handler(env, event):
    ...
    # Configure
    try:
        is_container_active = check_container_instance_status(cluster_name,instance_id,"ACTIVE")
        ...
        is_container_draining = check_container_instance_status(cluster_name,instance_id,"DRAINING")
