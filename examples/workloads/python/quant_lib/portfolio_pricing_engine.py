...
if __name__ == "__main__":
    ...
    with open('./../../../client/python/sample_portfolio.json') as json_file:
        ...
        european_options_expected_results = [0.030334, 0.030334, 0.030334, 0.030334, 0.030334, 0.030287, 0.030342, 0.030392, 0.030342, 0.030303, 0.030334, 0.030334, 0.033163, 0.030293]
        american_options_expected_results = [4.462235, 4.455663, 4.488701, 4.489087, 4.489040, 4.482594, 4.489087, 4.489066, 4.488663, 4.488663]

        all_expected_results = european_options_expected_results + american_options_expected_results
